...
gulp.task('img', function () {
  ...
  return stream.pipe(gulp.dest(path.join(config.dest, 'img')));
});
...
gulp.task('js', function() {
    streamqueue({ objectMode: true },
      ...
      gulp.src(['src/templates/**/*.html']).pipe(templateCache({ module: 'WebApp' }))
    )
...
gulp.task('build', function(done) {
  var tasks = ['html', 'fonts', 'images', 'img', 'less', 'js'];
